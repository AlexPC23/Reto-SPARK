...
object TransformacionesLocal extends {
  ...
  def RecogidaInicial(date: String): Unit = {
    ...
    val DWE_VM_ELTREPOB2 = DWE_VM_ENTLTPRE.filter((DWE_VM_ELTREPOB("DESDE_DT").lt(lit("2017-08-01")) && (DWE_VM_ELTREPOB("DESDE_DT").gt(lit("2017-06-30")))) || (DWE_VM_ELTREPOB("DESDE_DT").lt(lit("2017-07-01")) && (DWE_VM_ELTREPOB("HASTA_DT").gt(lit("2017-07-01")) || DWE_VM_ELTREPOB("HASTA_DT").isNull))) //E
